    ...
    class RelacionamentoInstitucionalIntegracao extends SeiIntegracao
    {
        ...
        public function processarControladorAjax($strAcao)
        {
            switch ($strAcao) {
                ...
                case 'md_ri_servico_auto_completar' :
                    ...
                    $xml              = InfraAjax::gerarXMLItensArrInfraDTO($arrObjServicoDTO, 'IdServicoRI', 'Nome');
                            ...
                            if (!is_null($objDocumentoDTO)) {
                                ...
                                if($numeroSei){
                                    ...
                                    if ($objNumeroSeiValidacaoRN->validarNumeroSeiBotao($arrParamentros)) {
                                        ...
                                        $imgIcone = "modulos/relacionamento-institucional/imagens/svg/cadastrar.svg";
        ...
        public function montarBotaoDocumento(ProcedimentoAPI $objProcedimentoAPI, $arrObjDocumentoAPI)
        {
            ...
            foreach ($arrObjDocumentoAPI as $documentoAPI) {
                ...
                if ($objNumeroSeiValidacaoRN->validarNumeroSeiBotao($arrParamentros)) {
                    ...
                    $imgIcone = "modulos/relacionamento-institucional/imagens/svg/responder.svg";
                ...
                if ($objNumeroSeiValidacaoRN->validarNumeroSeiBotao($arrParamentros)) {
                    ...
                    $imgIcone = "modulos/relacionamento-institucional/imagens/svg/reiteracao.svg";
        ...
        private function getArrayIconesRI( $objProcedimentoAPI, $isArvoreProcesso ){
        	...
        	if( is_array( $arrMdRiCadastroDTO ) && count( $arrMdRiCadastroDTO ) > 0 ){
        		...
        		$icone = "modulos/relacionamento-institucional/imagens/svg/icone_processo_sem_pendencia_resposta_merito.svg";
...
class="imagemStatus" style="padding-top: 1px" /></a>';
        ...
        public function desativarUnidade($arrObjUnidadeAPI)
        {
            ...
            $objMdRiRelCriterioCadastroUnidadeRN = new MdRiRelCriterioCadastroUnidadeRN();
            $objMdRiRelCriterioCadastroUnidadeDTO = new MdRiRelCriterioCadastroUnidadeDTO();
            $objMdRiRelCriterioCadastroUnidadeDTO->setNumIdUnidade($arrIds, InfraDTO::$OPER_IN);
            $objMdRiRelCriterioCadastroUnidadeDTO->retTodos();
            $countUnidade = $objMdRiRelCriterioCadastroUnidadeRN->contar($objMdRiRelCriterioCadastroUnidadeDTO);

            if ($countUnidade > 0) {
                $objInfraException = new InfraException();
                $objInfraException->adicionarValidacao('Não é possível desativar esta Unidade, pois a mesma está vinculada aos Critérios para Cadastro do Módulo Relacionamento Institucional.');
                $objInfraException->lancarValidacoes();
            }


            return parent::desativarUnidade($arrObjUnidadeAPI); // TODO: Change the autogenerated stub
        }
        ...
        public function excluirUnidade($arrObjUnidadeAPI)
        {
            ...
            if ($countUnidade > 0) {
                $objInfraException = new InfraException();
                $objInfraException->adicionarValidacao('Não é possível excluir esta Unidade, pois a mesma está vinculada aos Critérios para Cadastro do Módulo Relacionamento Institucional.');
                $objInfraException->lancarValidacoes();
            }


            return parent::excluirUnidade($arrObjUnidadeAPI); // TODO: Change the autogenerated stub
        }
    }