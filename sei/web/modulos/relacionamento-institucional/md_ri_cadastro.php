    ...
    switch ($_GET['acao']) {
        ...
        try {
            ...
            if ($countDE > 0) {
                ...
                $inputHdnContato ='<input type=\'text\' id=\'hdnRetornoModal\' disabled=\'disabled\' name=\'hdnRetornoModal\' class=\'color-input\' style=\'font-size:1.0em;font-family:helvetica; border: 0px solid\' value=\''.$arrDadosGridDemandante['nomeContato'].'\'>';
...
<?php
    if ($countRespostasDTO > 0) {
        ...
        <div class="bloco" style="width: 210px;">
            <a onclick="changeTela('RP')" class="ancoraPadraoPreta"><span>Respostas</span></a>
        </div>
    <?php } ?>
...
<?php
    if ($countReiteracaoDTO > 0) {
        ...
        <div class="bloco" style="width: 280px;">
            <a onclick="changeTela('RI')" class="ancoraPadraoPreta"><span>Reiterações</span></a>
        </div>
    <?php } ?>
...
<?php require_once 'md_ri_cadastro_bloco_controle_sobre_demanda.php'; ?>
    ...
    <div class="clear">&nbsp;</div>
     ...
     <div class="bloco" id="divInfoComplementar" style="width: 99%;">
        ...
        <textarea id="txtInfoComplementar" name="txtInfoComplementar" class="infraTextArea" maxlength="1000" style="width: 100%; margin: 0px; height: 55px;" onkeypress="return infraLimitarTexto(this,event,1000);" tabindex="<?= PaginaSEI::getInstance()->getProxTabDados() ?>"><?= $txtInformacoesComplementares ?></textarea>
...
?>
    ...
    <input type="hidden" name="idProcedimento" id="idProcedimento" value="<?php echo isset($_GET['id_procedimento']) ? $_GET['id_procedimento'] : $_POST['hdnIdProcedimento']; ?>"/>
    ...
    <input type="hidden" name="hdnDescricaoUnidadeAtual" id="hdnDescricaoUnidadeAtual" value="<?= $descricaoUnidadeAtual ?>"/>
    
    <input type="hidden" name="hdnDescricaoUnidadeAtual" id="hdnDescricaoUnidadeAtual" value="<?= $descricaoUnidadeAtual ?>"/>
    <input type="hidden" name="hdnLinkCadastroResposta" id="hdnLinkCadastroResposta" value="<?php echo $strUrlCadastroResposta ?>"/>
    <input type="hidden" name="hdnLinkCadastroReiteracao" id="hdnLinkCadastroReiteracao" value="<?php echo $strUrlCadastroReiteracao ?>"/>
